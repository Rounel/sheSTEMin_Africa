...
export function HeroSection() {
  ...
  return (
    <section className="w-full bg-pink-600 py-16 md:py-24 relative overflow-hidden">
      {/* Decorative stars */}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 text-white mb-10 md:mb-0">
          ...
          <RevealWrapper delay={0.3} direction="up">
            <h1 className="text-4xl md:text-7xl font-bold mb-6 leading-20">{t("hero.title")}</h1>
          </RevealWrapper>
